...
Поработал с картинками и гитигнор, почему-то эта информация исчезла, видно когда делал ДЗ-1 и эксперементировал с ветками это было потеряно.

На данный момент ветка 2 и 3 отличаются только конечными строками с 278 по 281

В ветке new2 сейчас меньше данных чем в ветке new3

Добавляю данные из ветки new4
Создана  ветка new4

Удалены ветки 3, 4, new из первого семинара

Удалены ветки new1, new2, new3, new4

Комментарии по ДЗ_3:
Для выполнения ДЗ-3 нужно 
Дополнить файл с инструкцией по работе с git  и направить pull request в репозиторий преподавателя.
https://github.com/cheklinim/seminar3_HW
Обязательно создать отдельную ветку после клонирования репозитория.
